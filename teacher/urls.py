...
urlpatterns = [
    ...
    path('upload_course_files/', views.upload_course_files, name='upload_course_files'),
    path('upload_chunk/', views.upload_chunk, name='upload_chunk'),
    path('upload_course_chunk/', views.upload_course_chunk, name='upload_course_chunks'),
    path('merge_chunks/', views.merge_chunks, name='merge_chunks'),
    path('merge_course_chunks/', views.merge_course_chunks, name='merge_course_chunks'),
    ...
    path('load_course_files/', views.load_course_files, name='load_course_files'),
    path('download_file/', views.download_file, name='download_files'),
    path('download_course_file/', views.download_course_file, name='download_course_files'),
    ...
    path('delete_course_files/', views.delete_course_files, name='delete_course_files'),
    ...
    path('update_view_course_file/', views.update_view_course_file, name='update_view_course_files'),
    path('get_student_info/', views.get_student_info, name='get_student_info'),
    path('add_user_by_excel/', views.add_user_by_excel, name='add_user_by_excel_file'),
]
